		...
		<div className='living'>
			...
			<div className=''>
				...
				<ol className="">
					...
					<li>Your purpose is to be centered in church. a. every christian is to be involved in ministry ({scripObj['Ephesians 4:11-12']}) b. Therefore, your gifts ({scripObj['Rom 12:6-7']}, {scripObj['Eph 4:11-13']}, {scripObj['1 Corinthians 12:4-11']}, and {scripObj['1 Corinthians 12:27-31']}) + passion ({scripObj['Philippians 2:13']}) + needs (God's, others, community, church) = YOUR MINISTRY.</li>
				</ol>
				<p className="">In personal testimony, know that I got lost for too long a period of time because I trusted in my own way above God's way and paid huge penalties. Please learn from my mistakes. God's word leads to the only path of success. You, and all new Christians, are like the Israelites just on the edge of entering the promised land. God explained it to them and said this to them in {scripObj['Josh 1:7-9']}. Now knowledge of God's law is a good thing and never leads you wrong as you set your moral compass for good behavior; however, the really cool thing is since Jesus ascended to Heaven, Jesus promised and delivered his gift of grace under the New Covenant. {scripObj['Galatians 2:20']} and {scripObj['Colossians 3:1-3']} says that you, as a believer, now have Christ living inside of you and the Holy Spirit, who, with your permission, will guide you in every way necessary to stay on the right path. Congratulations to you on making the best decision of your life.</p>
			</div>
