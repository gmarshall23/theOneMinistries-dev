		...
		<main className='living'>
			...
			<div className=''>
				...
				<ol className="">
					...
					<li>Your purpose is to be centered in church. a. every christian is to be involved in ministry (Ephesians 4:11-12) b. Therefore, your gifts (Rom 12) + passion (Philippians 2:13) + needs (God's, others, community, church) = YOUR MINISTRY.</li>
				</ol>
