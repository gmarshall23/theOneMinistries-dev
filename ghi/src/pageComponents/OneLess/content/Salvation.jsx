		...
		<div className="salvation-content">
			...
			<div className=''>
				<blockquote className='p-3'>
					<p className=''>
						My Friend, I am glad you parked on this page. I say this without drama or exaggeration, but this is the most important question you will ever consider, “Why should God let you into Heaven?” It is also  the most important decision you will ever make as it has everything to do with where you will spend eternity. Please consider it carefully and soberly as this needs to be more than an emotional decision. If you are unsure or want to know more about who God is, click here: Meet God and get to know Him better. Understand just how much He loves you ({scripObj['John 3:16']}) and that He created you ({scripObj['Gen 1:26-27']}), ({scripObj['Jer 1:5']}) and that He loved you first {scripObj['1 John 4:19']}. Truthfully, God is the literal definition of love (1 John 4:8,16). OK, so if you are ready, walk through the list of questions below…And yes, God is excited and ready for you also.
					</p>
